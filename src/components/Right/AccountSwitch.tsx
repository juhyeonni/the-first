...
function AccountSwitch() {
    ...
    function handleToLogin(e: React.MouseEvent) {
        navigate("/login");
    }
                            ...
                            <ModalContent onClick={handleModalClick}>
                                <ModalHeader>
                                    <CloseButton onClick={handleCloseModal}>
                                        <CloseButtonLine />
                                        <CloseButtonLine style={{ transform: 'rotate(-45deg)' }} />
                                    </CloseButton>
                                </ModalHeader>
                                <ModalBox>
                                    <ModalBoxLogo>
                                        <ModalLogoImg src='https://lh6.googleusercontent.com/proxy/o78UGPJZFQ8ctYSvxLwy45dyQOYp5bS67ik-1zkZBdhd3Qe_CBBtyLaXxiFz-KdbAY-1wZv0KHTngeg-Vso8bT1rhyurFUmsMw4125xt9w8=s0-d'>
                                        </ModalLogoImg>
                                    </ModalBoxLogo>
                                    <ModalBoxForm>
                                        <ModalFormWrap>
                                            <Form1>
                                                <Form1Lavel>
                                                    <Form1Input/>
                                                    <Form1Span>전화번호, 사용자 이름 또는 이메일</Form1Span>
                                                </Form1Lavel>
                                            </Form1>
                                            <Form2>
                                                <Form2Lavel>
